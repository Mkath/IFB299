				...
				<p>
					<h2>Create an Account</h2>
						<form name="survey" onsubmit="return validate(survey)" action="processData.php" method="post">
							...
							<input type="text" name="Name" style="width: 500px" onkeypress="invisible('nameMissing')"><br>
							<span id="nameMissing" style="color:red; visibility:hidden">*Name is a required field</span>
							</br>
							User name (6 char' min.)<br>
							<input type="text" name="username" style="width: 500px" onkeypress="invisible('usernameMissing')"><br>
							<span id="usernameMissing" style="color:red; visibility:hidden">*User Name is a required field</span>
							</br><p>
							Password<br>
							...
							Email Address<br>
							<input type="text" name="email" style="width: 500px" onkeypress="invisible('emailMissing')"><br>
							...
							Gender<br>
							<input type="radio" name="male" value="male" onclick="invisible('genderError')"> <font size="2">Male</font>
							<input type="radio" name="female" value="female" onclick="invisible('genderError')"> <font size="2">Female</font>
							<span id="genderError" style="color:red; visibility:hidden">*Gender is a required field</span>
							</br><p>
							Address<br>
							<textarea rows="3" cols="30" name="address" style="width: 500px" onkeypress = "invisible('addressError')"></textarea></br>
