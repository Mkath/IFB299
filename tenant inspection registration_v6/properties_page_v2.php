...
*/
if (isset($_POST['timeOption']) && $_POST['timeOption'] != '0') {
...
<div id="outside">
	...
	<div id="bigContent"> 
		...
		/*		
			...
			*/
						echo "<form method='post' action='properties_page_v2.php?ID=".$p_id."'>";
					  //tenant id and property id here----------------------------------------------------------------
			   		...
			   		//	echo '&nbsp; &nbsp;Open for Inspection Times & Please select the time';
						...
						echo '<option value="0">Open for Inspection Times & Please select the time</option>';
